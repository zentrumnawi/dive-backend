...
LIGHT_CHOICES = (
    ...
    ("L2 - zwischen Tiefschatten- und Schattenpflanze", "L2 - zwischen Tiefschatten- und Schattenpflanze"),
    ("L3 - Schattenpflanze", "L3 - Schattenpflanze"),
    ("L4 - zwischen Schatten- und Halbschattenpflanze", "L4 - zwischen Schatten- und Halbschattenpflanze"),
    ("L5 - Halbschattenpflanze", "L5 - Halbschattenpflanze"),
    ("L6 - zwischen Halbschatten- und Halblichtpflanze", "L6 - zwischen Halbschatten- und Halblichtpflanze"),
...
TEMP_CHOICES = (
    ...
    ("T4 - zwischen Kühle- und Mäßigwärmezeiger", "T4 - zwischen Kühle- und Mäßigwärmezeiger"),
    ("T5 - Mäßigwärmezeiger", "T5 - Mäßigwärmezeiger"),
    ("T6 - zwischen Mäßigwärme- und Wärmezeiger", "T6 - zwischen Mäßigwärme- und Wärmezeiger"),
    ("T7 - Wärmezeiger", "T7 - Wärmezeiger"),
    ("T8 - zwischen Wärme- und extremer Wärmezeiger","T8 - zwischen Wärme- und extremer Wärmezeiger"),
...
HUMID_CHOICES = (
    ...
    ("F2 - zwischen Starktrocknis- und Trockniszeiger", "F2 - zwischen Starktrocknis- und Trockniszeiger"),
    ("F3 - Trockniszeiger", "F3 - Trockniszeiger"),
    ("F4 - zwischen Trocknis- und Frischezeiger", "F4 - zwischen Trocknis- und Frischezeiger"),
    ("F5 - Frischezeiger", "F5 - Frischezeiger"),
    ("F6 - zwischen Frische- und Feuchtezeiger", "F6 - zwischen Frische- und Feuchtezeiger"),
    ("F7 - Feuchtezeiger", "F7 - Feuchtezeiger"),
    ("F8 - zwischen Feuchte- und Nässezeiger", "F8 - zwischen Feuchte- und Nässezeiger"),
...
REACT_CHOICES = (
    ...
    ("R2 - zwischen Starksäure- und Säurezeiger", "R2 - zwischen Starksäure- und Säurezeiger"),
    ("R3 - Säurezeiger", "R3 - Säurezeiger"),
    ("R4 - zwischen Säure- und Mäßigsäurezeiger", "R4 - zwischen Säure- und Mäßigsäurezeiger"),
    ("R5 - Mäßigsäurezeiger", "R5 - Mäßigsäurezeiger"),
    ("R6 - zwischen Mäßigsäurezeiger und Schwachsäure- bis Schwachbasenzeiger", "R6 - zwischen Mäßigsäurezeiger und Schwachsäure- bis Schwachbasenzeiger"),
    ("R7 - Schwachsäure- bis Schwachbasenzeiger"," R7 - Schwachsäure- bis Schwachbasenzeiger"),
    ("R8 - zwischen Schwachsäure- bis Schwachbasen- und Basen- und Kalkzeiger", "R8 - zwischen Schwachsäure- bis Schwachbasen- und Basen- und Kalkzeiger"),
...
NUTRIENT_CHOICES = (
    ("N1 - stickstoffärmste Stanorte anzeigend", "N1 - stickstoffärmste Stanorte anzeigend"),
    ("N2 - zwischen stickstoffärmsten und -armen Standorten", "N2 - zwischen stickstoffärmsten und -armen Standorten"),
    ("N3 - häufig auf stickstoffarmen Standorten", "N3 - häufig auf stickstoffarmen Standorten"),
    ("N4 - zwischen: häufig auf stickstoffarmen und mäßig -reichen Standorten", "N4 - zwischen: häufig auf stickstoffarmen und mäßig -reichen Standorten"),
    ("N5 - mäßig stickstoffreiche Standorte", "N5 - mäßig stickstoffreiche Standorte"),
    ("N6 - zwischen: mäßig und häufig anstickstoffreichen Standorten", "N6 - zwischen: mäßig und häufig anstickstoffreichen Standorten"),
    ("N7 - häufig an stickstoffreichen Standorten", "N7 - häufig an stickstoffreichen Standorten"),
    ("N8 - zwischen: häufig an und übermäßig stickstoffreichen Stanorten", "N8 - zwischen: häufig an und übermäßig stickstoffreichen Stanorten"),
    ("N9 - übermäßig stickstoffreiche Standorte", "N9 - übermäßig stickstoffreiche Standorte"),
