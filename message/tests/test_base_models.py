...
class TestMessageModelFields:
    ...
    def test_field_type_type(self, message_model_class):
        assert isinstance(
            message_model_class._meta.get_field("type"), models.CharField
        )
    ...
    def test_field_type_text(self, message_model_class):
        assert isinstance(
            message_model_class._meta.get_field("text"), models.TextField
        )
        
    def test_field_type_img(self, message_model_class):
        assert isinstance(
            message_model_class._meta.get_field("img"), models.ImageField
        )
